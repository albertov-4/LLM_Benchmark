...
\begin{itemize}
    ...
    \item \textbf{Single Model Release Evaluation:} The benchmark could be used to evaluate different releases of the same model, to test how its planning capabilities evolve across versions.
