...
\begin{frame}{Main Results}\footnotesize
    ...
    \vspace{0.2cm}
    This graph can tell us whether a model is good in finding a plan for a domain.
...
\begin{frame}{Future Work}\footnotesize
    ...
    \begin{itemize}
        ...
        \item use the stored artifacts for deeper correlation studies across failures, domains and model families.
    \end{itemize}
\end{frame}
