Success Rate, First-Attempt Success Rate, Iteration-Weighted Success Rate, Retry Gap SSand the iteration profile that distinguishes genuine correction from stochastic resampling.
...
\code{sr\_fasr\_iwsr\_by\_model},\allowbreak{}S
