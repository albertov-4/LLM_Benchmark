...
Applicando queste due classificazioni ed ipotizzando di scegliere 3 diversi problemi classificati in base al tipo di planning si dovrebbe poi andare a decidere di calssificare in base alla difficoltà e per ogni progetto scelto si prevede un massimo di 3 livelli di difficoltà: facile, medio e difficile. In totale tuttavia in questo modo si avrebbero 3 diversi problemi su cui lavorare 3 istanze diverse ciascuno 8quindi in totale 9 problemi) 
