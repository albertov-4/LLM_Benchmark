...
Also a quick PDDL starting guide has been created to better gain the necessary knowledge about PDDL specific language used to define planning problems.
