...
\begin{frame}{Problems Chosen}\footnotesize
    To conclude the Problems' Classification chapter it's useful to highlight among all the problems available the selected ones, since the Temporal Planning and Logic reasoning types have just as single related problem it is better not to include them in the selection hence we selected problems among all the remaining reasoning categories.\\
