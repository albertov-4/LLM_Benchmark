Within-domain ranking and its direction rules, the per-domain heatmap normalisation caveat and the seven literature-grounded capability profiles with their NaN-aware assignment logic.
